class Weather {
  final double kelvinConversionSubtrahend = 273.15;
  String name = '';
  String description = '';
  ...
  Weather.fromJson(Map<String, dynamic> weatherMap) {
    ...
    temperature =
        (weatherMap['main']['temp'] - kelvinConversionSubtrahend) ?? 0;
    perceived =
        (weatherMap['main']['feels_like'] - kelvinConversionSubtrahend) ?? 0;
